...
int main()
{
    ...
    //changing of data recieved from clinet1
    server_data.character = server_data.character +6; 
    server_data.integer = (server_data.integer - 2) * 10;
    server_data.floatnum = server_data.floatnum * 7.0;
